...
Sustainment & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=sustainment]{(0,0)}}} \\ \hline
Tactical Sattelite & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=tactical sattelite]{(0,0)}}} \\ \hline
Signal Tactical Sattelite & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=signal tactical sattelite]{(0,0)}}} \\ \hline
Topographic & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=topographic]{(0,0)}}} \\ \hline
Transportation & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=transportation]{(0,0)}}} \\ \hline
Unmanned Systems & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=unmanned systems]{(0,0)}}} \\ \hline
Video Imagery & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=video imagery]{(0,0)}}} \\ \hline
Water & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=water]{(0,0)}}} \\ \hline
Water Purification & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=water purification]{(0,0)}}} \\ \hline
Civilian Police & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=civilian police]{(0,0)}}} \\ \hline
Environmental Protection & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=environmental protection]{(0,0)}}} \\ \hline
Government Organization & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=government organization]{(0,0)}}} \\ \hline
Internal Security Force & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=internal security force]{(0,0)}}} \\ \hline
Individual & \trimbox{0cm, 0.25cm, 0.275cm, 0.25cm}{\tikz[baseline=-0.5ex]{\NATOLand[scale=2, faction=none, main=individual]{(0,0)}}} \\ \hline

...
Force & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=force]{(0,0)}}} \\ \hline
Forward & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=forward]{(0,0)}}} \\ \hline
Ground Station Module & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=ground station module]{(0,0)}}} \\ \hline
Landing Support & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=landing support]{(0,0)}}} \\ \hline
Large Extension Node & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=large extension node]{(0,0)}}} \\ \hline
Maintenance & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=maintenance]{(0,0)}}} \\ \hline
Meteorological & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=meteorological]{(0,0)}}} \\ \hline
Mine Countermeasure & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=mine countermeasure]{(0,0)}}} \\ \hline
Missile & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=missile]{(0,0)}}} \\ \hline
Mobile Advisor And Support & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=mobile advisor and support]{(0,0)}}} \\ \hline
Mobile Subscriber Equipment & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=mobile subscriber equipment]{(0,0)}}} \\ \hline
Mobility Support & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=mobility support]{(0,0)}}} \\ \hline
Movement Control Centre & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=movement control centre]{(0,0)}}} \\ \hline
Multinational & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=multinational]{(0,0)}}} \\ \hline
Multinational Specialized Unit & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=multinational specialized unit]{(0,0)}}} \\ \hline
Multiple Rocket Launcher & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=multiple rocket launcher]{(0,0)}}} \\ \hline
Nato Medical Role 1 & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=NATO medical role 1]{(0,0)}}} \\ \hline
Nato Medical Role 2 & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=NATO medical role 2]{(0,0)}}} \\ \hline
Nato Medical Role 3 & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=NATO medical role 3]{(0,0)}}} \\ \hline
Nato Medical Role 4 & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=NATO medical role 4]{(0,0)}}} \\ \hline
Naval & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=naval]{(0,0)}}} \\ \hline
Node Centre & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=node centre]{(0,0)}}} \\ \hline
Nuclear & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=nuclear]{(0,0)}}} \\ \hline
Operations & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=operations]{(0,0)}}} \\ \hline
Radar & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=radar]{(0,0)}}} \\ \hline
Radiological & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=radiological]{(0,0)}}} \\ \hline
Search And Rescue & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=search and rescue]{(0,0)}}} \\ \hline
Security & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=security]{(0,0)}}} \\ \hline
Sensor & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=sensor]{(0,0)}}} \\ \hline
Sensor Control Module & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=sensor control module]{(0,0)}}} \\ \hline
Signals Intelligence & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=signals intelligence]{(0,0)}}} \\ \hline
Single Shelter Switch & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=single shelter switch]{(0,0)}}} \\ \hline
Single Rocket Launcher & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=single rocket launcher]{(0,0)}}} \\ \hline
Smoke & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=smoke]{(0,0)}}} \\ \hline
Sniper & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=sniper]{(0,0)}}} \\ \hline
Sound Ranging & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=sound ranging]{(0,0)}}} \\ \hline
Special Weapons And Tactics & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=special weapons and tactics]{(0,0)}}} \\ \hline
Survey & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=survey]{(0,0)}}} \\ \hline
Tactical Exploitation & \trimbox{0.25cm, 0.25cm, 0.25cm, 0.25cm}{\tikz[baseline=-0.5ex, scale=2, transform shape]{\NATOLand[faction=none, upper=tactical exploitation]{(0,0)}}} \\ \hline

...
\NATOAir[faction=friendly, main=military airship](1,2)(A)
\NATOAir[faction=friendly, main=military balloon](8,4)(B)
\NATOLand[faction=friendly, supply={1}{2}](0,0)(C)
...
%\pic at (0, 0) {NATOSymb equipment/mobility/towed};
%\pic at (0, 0) {NATOSymb equipment/mobility/railroad};
%\pic at (0, 0) {NATOSymb equipment/mobility/tracked};

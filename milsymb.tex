...
\usepackage{milsymb, arev, ltablex, makecell, multirow, tikzpagenodes, vhistory, titlesec, float, forest, tocloft, alltt, array, tikz-dimline, threeparttable, textcomp, pifont, colortbl, caption}
...
\begin{center}
\begin{longtable}{|l|c|s|@{}m{0pt}@{}}
\hline
\thead{Value} & \rotatebox{90}{\thead{Roman Numeral}~} & \thead{Symbol}& \\ \hline
\texttt{all}* & N/A & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={all}{}]}& \\[1.25cm] \hline
\multicolumn{3}{|c|}{\thead{NATO Supply Classes}}& \\ \hline
\texttt{1} & I & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={1}{}]}&\\[1.25cm]\hline
\texttt{2} & II & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={2}{}]}&\\[1.25cm]\hline
\texttt{3} & III & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={3}{}]}&\\[1.25cm]\hline
\texttt{4} & IV & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={4}{}]}&\\[1.25cm]\hline
\texttt{5} & V & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={5}{}]}&\\[1.25cm]\hline
\multicolumn{3}{|c|}{\thead{US Supply Classes}} \\ \hline
\texttt{US 1} & I & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={US 1}{}]}&\\[1.25cm]\hline
\texttt{US 2} & II & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={US 2}{}]}&\\[1.25cm]\hline
\texttt{US 3} & III & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={US 3}{}]}&\\[1.25cm]\hline
\texttt{US 4} & IV & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={US 4}{}]}&\\[1.25cm]\hline
\texttt{US 5} & V & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={US 5}{}]}&\\[1.25cm]\hline
\texttt{US 6} & VI & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={US 6}{}]}&\\[1.25cm]\hline
\texttt{US 7} & VII & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={US 7}{}]}&\\[1.25cm]\hline
\texttt{US 8} & VIII & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={US 8}{}]}&\\[1.25cm]\hline
\texttt{US 9} & IX & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={US 9}{}]}&\\[1.25cm]\hline
\texttt{US 10} & X & \tikz[baseline=-0.5ex]{\MilLand[faction=none, supply={US 10}{}]}&\\[1.25cm]\hline
\multicolumn{4}{c}{}\\

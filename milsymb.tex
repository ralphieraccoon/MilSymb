...
\item The \textbf{Modifiers} are symbols that go above and below the icon (or to the left and right in the case of missile symbols). These \lq\lq{}modify\rq\rq{} the entity with additional features or information (equipped with rocket launchers, extra heavy, etc.)  These are usually optional.

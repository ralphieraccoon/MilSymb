...
\tikzset{
  /NATOSymb/.cd,
   ...
   %headquarters/.style={execute at end picture={\def\temp{friendly} \ifx\NATOSymb@selectedfaction\temp \draw (M.south west) -- +(0, -0.25); \fi}},
   %headquarters/.style={execute at end picture={\draw (M.south west) -- +(0, -0.25); }},
   ...
   altitude/.style 2 args={execute at end picture={ \fontsize{6}{0}\selectfont \ifx&##2& \node at (0,-0.34) {\acs{##1}}; \else  \node at (0,-0.34) [xscale=0.8] {\acs{##1S}/\acs{##2}}; \fi}},
...
\NATOLand[faction=friendly, main=above corps support, echelon=platoon, task force, status=reinforced and reduced, upper=mobile advisor and support, headquarters=forward command post, altitude={Low}{Medium}]

...
NATOSymb land/main/individual/.pic={
\draw (0, 0.125) circle (0.075);
\draw (0, 0.05) -- (0, -0.2);
\draw (0.075,0) -- (-0.075,0);
},
NATOSymb land/main/organization or group/.pic={
\pic [scale=0.9] at (0, -0.02) {NATOSymb land/main/individual};
\pic [scale=0.9] at (0.2, 0.02) {NATOSymb land/main/individual};
\pic [scale=0.9] at (-0.2, 0.02) {NATOSymb land/main/individual};
},
NATOSymb land/main/killing victim/.pic={
\pic {NATOSymb land/main/individual};
\draw (-0.41, 0.2) -- (0.41, -0.2);
},
NATOSymb land/main/killing victims/.pic={
\pic {NATOSymb land/main/organization or group};
\draw (-0.41, 0.2) -- (0.41, -0.2);
},
NATOSymb land/main/victim of an attempted crime/.pic={
\pic {NATOSymb land/main/individual};
...
NATOSymb land/lower/pack animal/.pic={
...
NATOSymb land/lower/railroad/.pic={
\draw (0.36, 0.125) -- (-0.35, 0.125);
\draw (0.3, 0.05) circle (0.06);
\draw (0.17, 0.05) circle (0.06);
\draw (-0.3, 0.05) circle (0.06);
\draw (-0.17, 0.05) circle (0.06);
},
...
NATOSymb equipment/main/tazer/.pic={
\pic {NATOSymb equipment/main/non lethal weapon};
\pic at (0, 0) {NATOSymb main/text={Z}};
},
NATOSymb equipment/main/water cannon/.pic={
\pic {NATOSymb equipment/main/non lethal weapon};
\pic at (0, 0) {NATOSymb main/text={W}};
},
...
\pic at (0, 0) {NATOSymb main/textsmall={C2}};
},
...
\pic at (0, 0) {NATOSymb main/textsmall={MF}};
},
...
NATOSymb equipment/main/sensor embedded/.pic={
...
\pic [scale=0.6] {NATOSymb multi/main/amphibious};
},
NATOSymb equipment/mobility/barge/.pic={
\draw (0.5, 0) -- (-0.5, 0) to [out=-90,in=-90,looseness=0.5] (0.5, 0) -- cycle;
},
NATOSymb equipment/mobility/over snow/.pic={
\draw (-0.5, 0.2) to[in=180, out=-90] (-0.3, 0) -- (0.5, 0);
},
...
\tikzset{
  /NATOSymb/.cd,
   ...
   main/individual/.style={/NATOSymb/.cd, symbC=land/main/individual},
   main/organisation or group/.style={/NATOSymb/.cd, symbC=land/main/organisation or group},
   main/killing victim/.style={/NATOSymb/.cd, symbC=land/main/killing victim},
   main/killing victims/.style={/NATOSymb/.cd, symbC=land/main/killing victims},
   main/victim of an attempted crime/.style={/NATOSymb/.cd, symbC=land/main/victim of an attempted crime},
   main/spy/.style={/NATOSymb/.cd, symbC=main/text, symbCT=SPY},
   supply/.style 2 args={execute at end picture={ \begin{scope}[shift={#2}] \ifx&##2& \pic at (0,0) {NATOSymb supply/class ##1};\else \node at (0,0) {\uppercase\expandafter{\romannumeral##1\relax} \& \uppercase\expandafter{\romannumeral##2\relax}}; \fi \end{scope}}},
   ...
   lower/.is choice,
   lower/none/.style= {/NATOSymb/.cd, symbL=main/textsmall, symbLT=},
   lower/airbourne/.style= {/NATOSymb/.cd, symbL=land/lower/airbourne},
   ...
   lower/close range/.style= {/NATOSymb/.cd, symbL=main/textsmall, symbLT=CR}
   lower/bicycle equipped/.style= {/NATOSymb/.cd, symbL=land/lower/control},
   ...
   altitude/.style 2 args={execute at end scope={\begin{scope}[shift={#2}] \fontsize{6}{0}\selectfont \ifx&##2& \node at (0,-0.34) {\acs{##1}}; \else  \node at (0,-0.34) [xscale=0.8] {\acs{##1S}/\acs{##2}}; \fi \end{scope}}},
   ...
   offset/.code 2 args={\begin{scope}[shift={#2}]\def\true{true} \ifx\NATOSymb@drawH\true \draw (-0.75, -0.75) -- +($(0, -##1) - (0, -0.75)$) -- +##2; \else \draw (0,0)  -- +(0, -##1) -- +##2; \fi\end{scope}},
   offset/.value required,
   movement/.code 2 args={\begin{scope}[shift={#2}]\def\true{true} \ifx\NATOSymb@drawH\true \draw [-{Stealth[inset=0pt,scale=1]}] (-0.75, -0.75) -- +($(0, -##1) - (0, -0.75)$) -- +##2; \else \draw [-{Stealth[inset=0pt,scale=1]}] (0,0)  -- +(0, -##1) -- +##2; \fi\end{scope}},
...
\iftaskforce
\draw ($(E.south west)+(0,0.04)$) -- (E.north west) -- (E.north east) -- ($(E.south east)+(0,0.04)$);
\fi
\iffeintdummy
...
\def\friendly{friendly} % Draw headquarters
\def\true{true}
\ifx\NATOSymb@selectedfaction\friendly
\ifx\NATOSymb@drawH\true  
...
\newcounter{exitem}
\newenvironment{landheadquarters}{
\begin{scope}
\setcounter{exitem}{0}
\renewcommand\item{
\ifnum \value{exitem}>0
\draw ($(M.south west) + (0, -0.25)$) -- +(0,-0.34);
\fi
\stepcounter{exitem}\scoped[yshift=-\theexitem*45]}
}{\end{scope}}
\newenvironment{landgroup}{
\begin{scope}[local bounding box=G]
\setcounter{exitem}{0}
\renewcommand\item{\stepcounter{exitem}\scoped[yshift=-\theexitem*45]}
}{
\draw ([shift={(5pt,0pt)}]G.north west) -| ([shift={(-3pt,-3pt)}]G.south west) -- ++(8pt,0)
 (G.west) -- ++(-5pt,0);
\end{scope}
}
\makeatother
...
\NATOLand[faction=friendly, main=above corps support, echelon=platoon, task force, status=reinforced, upper=mobile advisor and support, feint or dummy, country indicator=CAN, altitude={Low}{Medium}, movement={2}{(-1.6, 1)}]{(5,1)};
%
...
\item \NATOLand[faction=friendly, main=above corps support, echelon=platoon, status=reinforced and reduced, upper=mobile advisor and support,  headquarters=command group, altitude={Low}{Medium}]{(0,0)};
\item \NATOLand[faction=friendly, main=above corps support, echelon=platoon, task force, status=reinforced and reduced, upper=mobile advisor and support,  headquarters=command group, altitude={Low}{Medium}]{(0,0)};
...
\pic at (0, 0) {NATOSymb equipment/mobility/over snow};

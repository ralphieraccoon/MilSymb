...
\tikzset{
  /NATOSymb/.cd,
   ...
   staff comments/.store in= \NATOSymb@symbA,
   additional information/.store in=\NATOSymb@symbB,
   evaluation rating/.store in=\NATOSymb@symbD,
   nation/.store in= \NATOSymb@symbE,
   additional information/.store in=\NATOSymb@symbF,
...
\draw ($(G.south west) + (0, 0.06)$) -- +(0,-0.34);
\fi
...
\begin{scope}[local bounding box=G]
\setcounter{exitem}{0}
\renewcommand\item{\stepcounter{exitem}\scoped[yshift=-\theexitem*40]}
}{
...
\NATOLand[faction=friendly, main=above corps support, echelon=platoon, task force, status=reinforced and reduced, upper=mobile advisor and support, altitude={Low}{Medium}, offset={2}{(-1.6, 1)}]{(5,1)};
%
...
\pic at (0, 0) {NATOSymb equipment/main/water vehicle};

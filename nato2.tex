...
\NATOLand[faction=friendly, main=above corps support, echelon=platoon, task force, status=reinforced, upper=mobile advisor and support, country indicator=CAN, altitude={Low}{Medium}, offset={2}{(-1.6, 1)}]{(5,1)};
%

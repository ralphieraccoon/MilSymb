...
NATOSymb equipment/main/non leathal grenade launcher/.pic={
...
\tikzset{
  /NATOSymb/.cd,
   ...
   offset/.code 2 args={\begin{scope}[shift={#2}]\def\true{true} \ifx\NATOSymb@drawH\true \draw ([xshift=0.5\pgflinewidth]-0.75, -0.75) -- +($(0, -##1) - (0, -0.75)$) -- +##2; \else \draw (0,0)  -- +(0, -##1) -- +##2; \fi\end{scope}},
...
\draw ($([xshift=0.5\pgflinewidth]G.south west) + (0, 0.06)$) -- +(0,-0.34);
\fi
...
\pic at (0, 0) {NATOSymb equipment/main/anti tank rocket launcher};

...
\tikzset{
  /NATOSymb/.cd,
   ...
   lower/railroad/.style= {/NATOSymb/.cd, symbL=land/lower/radio relay line of sight},
...
\draw ($(M.south west) + (0, -0.25)$) -- +(0,-0.68);
\fi
\stepcounter{exitem}\scoped[yshift=-\theexitem*55]}
}{\end{scope}}
\newenvironment{landgroup}{
\begin{scope}[local bounding box=G]
\setcounter{exitem}{0}
\renewcommand\item{\stepcounter{exitem}\scoped[yshift=-\theexitem*50]}
}{

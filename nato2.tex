...
\tikzset{
  /NATOSymb/.cd,
   ...
   %drawH/.forward to=/NATOSymb/offset,
   ...
   altitude/.style 2 args={execute at end picture={\begin{scope}[shift={#2}] \fontsize{6}{0}\selectfont \ifx&##2& \node at (0,-0.34) {\acs{##1}}; \else  \node at (0,-0.34) [xscale=0.8] {\acs{##1S}/\acs{##2}}; \fi \end{scope}}},
...
\draw ($([xshift=0.5\pgflinewidth]current bounding box.south west) + (0, 0.05)$) -- +(0,-0.33);
\fi
...
\draw ([shift={(5pt,0pt)}]current bounding box.north west) -| ([shift={(-3pt,-3pt)}]current bounding box.south west) -- ++(8pt,0)
...
\pic at (0, 0) {NATOSymb land/main/victim of an attempted crime};
